...
namespace wv2util
{
    public static class ProcessUtil
    {
        ...
        public struct ParentProcessUtil
        {
            ...
            [DllImport("ntdll.dll")]
            private static extern int NtQueryInformationProcess(IntPtr processHandle, int processInformationClass, ref ParentProcessUtil processInformation, int processInformationLength, out int returnLength);
            ...
            {
                ParentProcessUtil pbi = new ParentProcessUtil();
                int returnLength;
